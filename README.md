...
```sh
# macOS (Apple Silicon)
curl -L https://github.com/secrets-cli/secrets/releases/download/v0.1.0/secrets_0.1.0_darwin_arm64.tar.gz | tar xz
sudo mv secrets /usr/local/bin/

# Linux / WSL (amd64)
curl -L https://github.com/secrets-cli/secrets/releases/download/v0.1.0/secrets_0.1.0_linux_amd64.tar.gz | tar xz
sudo mv secrets /usr/local/bin/
```
